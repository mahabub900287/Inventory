<x-admin.layouts.app :title="getbreadcumb()">
    ...
    <div class="ic-upload-content ic-table-content rounded-0">
        ...
        <div class="row mt_30 mb_30 justify-content-center">
            <div class="col-lg-8">
                <x-form method="PUT" action="{{ route('company.packaging.update', $item->id) }}">
                                    ...
                                    <div class="ic-basic-info-card mb_30">
                                        <div class="mb_20">
                                            <x-form_input label="Name" placeholder="Name of the product"
                                                name="name" errorName='name' value="{{ $item->name ?? old('name') }}"
                                                required="required">
                                            </x-form_input>
                                        </div>
                                        <div class="mb_20">
                                            <div class="mb_20">
                                                <x-form_input label="SKU" placeholder="Sku of the product"
                                                    name="sku" errorName='sku'
                                                    value="{{ $item->sku ?? old('sku') }}" required="required">
                                                </x-form_input>
                                                {{-- <label class="form-label">SKU (Auto Genarate)</label>
                                                <input type="text" class="form-control"
                                                    value="{{ $item->sku ?? old('sku') }}"
                            ...
                            <div class="col-md-6">
                                <div class="ic-measurement-area">
                                        ...
                                        <div class="ic-basic-info-card">
                                            <div class="mb_20">
                                                ...
                                                <select class="ic-select" name="type"
                                                    aria-label="Select Barcode Type" placeholder="Select Barcode Type">
                                                    <option value="box" {{ $item->type == 'box' ? 'selected' : '' }}>
                                                        Box
                                                    </option>
                                                    <option value="envelope"
                                                        {{ $item->type == 'envelope' ? 'selected' : '' }}>
                                                        envelope
                                                    </option>
                                                </select>
                                                @if (!empty('type'))
                                    ...
                                    <div class="ic-prepacked">
                                        @php
                                            $masurement = json_decode($item->masurement, true);
                                        @endphp
                                            ...
                                            <div class="mb_20">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" id="length" name="length"
                                                        value="{{ $masurement['length'] ?? 0 }}" class="form-control"
                                                        placeholder="0">
                                            ...
                                            <div class="mb_20">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" id="width" name="width"
                                                        value="{{ $masurement['width'] ?? 0 }}" class="form-control"
                                                        placeholder="0">
                                                    <span class="input-group-text">cm</span>
                                                </div>
                                                @if (!empty('width'))
                                            ...
                                            <div class="mb_20">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" id="height" name="height"
                                                        value="{{ $masurement['height'] ?? 0 }}" class="form-control"
                                                        placeholder="0">
                                                    <span class="input-group-text">cm</span>
                                                </div>
                                                @if (!empty('height'))
