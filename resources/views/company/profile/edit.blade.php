<x-admin.layouts.app :title="getbreadcumb()">
    <div class="ic-user">
        ...
        <x-form method="POST" action="{{ route('company.profile.update', Auth()->user()->id) }}"
                        ...
                        <div class="ic_form row row-cols-md-2 row-cols-sm-2 gx-xxl-4 gx-xl-2 gx-sm-2">
                            ...
                            <div class="mb_20">
                                <x-form_input label="First Name" placeholder="Enter your first name" name="first_name"
                                    errorName='first_name' value="{{ Auth()->user()->first_name }}" required="required">
                                </x-form_input>
                            </div>
                            <!-- LAst name -->
                            <div class="mb_20">
                            ...
                            <div class="mb_20">
                                <x-form_input label="Email" placeholder="Enter your email" name="email"
                                    errorName='email' value="{{ Auth()->user()->email }}" required="required">
                                </x-form_input>
                            </div>
                            <!-- company name -->
                            <div class="mb_20">
                            ...
                            <div class="mb_20">
                                <x-form_input label="Country" placeholder="Enter your country" name="country"
                                    errorName='country' value="{{ Auth()->user()->country }}">
                                </x-form_input>
                            </div>
