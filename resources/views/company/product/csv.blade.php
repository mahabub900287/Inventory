<x-admin.layouts.app :title="getbreadcumb()">
    ...
    <div class="inventory-heading">
        ...
        <a class="ic-close-btn" href="{{ route('company.product.index') }}"><i class="ri-close-fill"></i></a>
    </div>
    <div class="ic-upload-content ic-table-content">
        ...
        <div class="upload-bottom-uploader mt_30 mb_30">
            <div class="ic-help-template-wrapper mb_20">
                ...
                <a role="button" class="ic-button primary px-3" download="" href="{{ asset('csv/product.csv') }}">
                    <i class="ri-add-fill"></i>
                    <span>Download Template</span>
                </a>
            </div>
            <x-form method="POST" action="{{ route('company.product.csv.store') }}" enctype="multipart/form-data">
                @csrf
